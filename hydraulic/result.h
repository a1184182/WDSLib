...
class Result{
	public:
	    ...
	    /** Set the final G and F matrices
	      ...
	      *
	      */
		void setGFfinal(vector<double>* ,vector<double>* ,double );
		...
		/** Set the iterative norms
	      ...
	      *
	      */ 
	    void setIterNorm(double ,double ,double );
