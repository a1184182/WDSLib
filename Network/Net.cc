...
//  called from: 
//-------------------------------------------------------------------------
	cout<<"Number of Pipes:"<<Npipes<<endl;
	cout<<"Number of Nodes:"<<Njuncs<<endl;
	cout<<"Number of Sources:"<<Nsources<<endl;
	cout<<"Unit:"<<unit<<endl;
	cout<<"Flow Unit:"<<flowUnit<<endl;
	cout<<"Pressure Unit:"<<pressureUnit<<endl;
	cout<<"Headloss Model:"<<hdlss<<endl;
	node->dispNodes();
	pipe->dispPipes(topology->getSN(),topology->getEN());
}
