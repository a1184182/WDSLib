...
class PIPE //: public Edge
{
	public:
		...
		void permutePipe(PIPE*,vector<int>*);
	      ...
	      *
	      */
   		void dispPipes(vector<int>*,vector<int>*);
	      ...
	      */
		void dispPipeScale(){
			cout<<"Pipe Length Scaling factor="<<Lscale<<endl;
			cout<<"Pipe Diameter Scaling factor="<<Dscale<<endl;
			cout<<"Pipe Roughness Scaling factor="<<Rscale<<endl;
		}
	private:
		vector<string>	*ID;
